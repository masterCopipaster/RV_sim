...
#define _TRD rdbuf //proc.reg[rd] //proc.reg[enc.rd]
#define _TRS1 proc.reg[rs1] //proc.reg[enc.rs1]
#define _TRS2 proc.reg[rs2] //proc.reg[enc.rs2]
#define _TPC proc.pc
#define _PCB pcbuf
#define _TBR proc.branch
#define _STALL proc.stall
#define _SETBR _TBR = 1;
...
#include "tinstr_autogen.h"

class ecall_tinstr : public tinstruction
{
	public:
	ecall_tinstr(uint32_t opcode) :tinstruction() {}
	int execute(tproc_state& proc)
	{
		//['rs1', 'rs2', 'storeimm']
		printf("ecall\n");
